...
| [`end_to_end_vpc_v5`](examples/end_to_end_vpc_v5) | VPC v5, rule group, policy, firewall, routes, and CloudWatch logging. | CI rewrites the unreleased VPC source to a contract fixture; real traffic requires AWS acceptance. |
